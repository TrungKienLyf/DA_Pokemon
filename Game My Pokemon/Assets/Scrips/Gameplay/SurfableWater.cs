...
public class SurfableWater : MonoBehaviour, Interactable, IPlayerTriggerable
{
    ...
    public IEnumerator Interact(Transform initiator)
    {
        ...
        yield return DialogManager.Instance.ShowDialogText("Có vẻ nước khá sâu !!");
        yield return DialogManager.Instance.ShowDialogText("Pokemon học được Surf có thể sẽ hữu ích.");
        ...
        if (pokemonWithSurf != null)
        {
            ...
            yield return DialogManager.Instance.ShowDialogText($"Bạn có để {pokemonWithSurf.Base.Name} sử dụng surf không?",
            ...
            {
                // Yes
                yield return DialogManager.Instance.ShowDialogText($"{pokemonWithSurf.Base.Name} đã sử dụng surf!");
